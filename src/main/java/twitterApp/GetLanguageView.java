...
public class GetLanguageView extends JFrame {
	...
	public GetLanguageView(JFrame p) {
		...
		JLabel lblHashtag = new JLabel("Consultations des tweets par langage");
		...
		Thread t = new ThreadGetLanguage(txtpnHello);
		t.start();
	}
}